    ...
    <div class="r-menu">
        ...
        <c:forEach items="${categories}" var="c" varStatus="vs">
            <c:if test="${vs.count>=1 and vs.count<=4}">
                <a style="margin-left: 20px;font-size:16px;font-weight: bold;color:#2c2c2c; " href="category?id=${c.id}">${c.name}</a>
            </c:if>
        </c:forEach>
    </div>
</section>
...
<section class="carousel">
    <div data-ride="carousel" class="carousel-of-product carousel slide" id="carousel-of-product" >
        ...
        <div role="listbox" class="carousel-inner">
            ...
            <div class="item">
                <a href="/product?id=2" target="_blank">
                <img src="img/2.jpg" class="carousel-image">
                </a>
            </div>
            <div class="item">
                <a href="/product?id=3" target="_blank">
